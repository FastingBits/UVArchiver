...
const getSystemAdminStats = async () => {
    try {
        ...
        // top 5 departamentos con mas documentos   
...
const getUserStats = async (idDepartamento, idUsuario, username) => {
    try {
        ...
        // Distribución de extensiones de archivo, las 5 extensiones mas usadas 
...
const getAuditorStats = async (idDepartamento) => {
    try {
        ...
        // Actividad por usuario (documentos públicos subidos por cada uno), usuario con más documentos primero y limitado a 5
        ...
        // Últimos 5 documentos públicos modificados
